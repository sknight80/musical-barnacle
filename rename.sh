...
[[ ! -d 'better-wp-plugin-boilerplate/plugin-name' ]] && echo "Missing 'better-wp-plugin-boilerplate/plugin-name' directory." && exit 1
...
cp better-wp-plugin-boilerplate/ $plugin_name
cd $plugin_name
